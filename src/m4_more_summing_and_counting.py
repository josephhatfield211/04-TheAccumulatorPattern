...
def sum_from(m, n):
    ...
    if m <= n:
        ...
        print("M needs to be smaller or equal to N")
...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 3
    answer = count_cosines_from(4, 9, 0.19)
    ...
    # Test 4:
    expected = 3
    answer = count_cosines_from(4, 7, 0.11)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 2
    answer = count_cosines_from(0, 3, 0.5)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 0
    answer = count_cosines_from(2, 4, 0.34)
